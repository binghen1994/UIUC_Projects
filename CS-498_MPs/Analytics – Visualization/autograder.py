...
student = {
    "submitterEmail": "yuluw2@illinois.edu", #<Your coursera account email>
    "secret": "nrLJfBYCGjgJU88B" #<Your secret token from coursera>
}
...
viz0CsvPath = "D:\mp9-viz0.csv" #<Filepath for your tableau viz0 csv/tsv file>
viz1CsvPath = "D:\mp9-viz1.csv" #<Filepath for your tableau viz1 csv/tsv file>
viz2CsvPath = "D:\mp9-viz2.csv" #<Filepath for your tableau viz2 csv/tsv file>
...
viz2ArrivalDelayColumn = 1 # <0 if the first column is the arrival delay, else 1>
